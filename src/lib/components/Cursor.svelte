...
>
	<div
		...
		class={clsx(
			'size-full max-h-8 max-w-8 rounded-full border-2 border-primary-500 transition-[max-height_max-width]',
...
>
	<div class="size-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary-500"></div>
</div>
